...
`parser.c` (and any scanner) under `Sources/TreeSitterLua/src/` so SPM can
...
| Field | Value |
| --- | --- |
| Last reviewed commit | `10fe0054734eec83049514ea2e718b2a56acd0c9` |
| Provenance | verified byte-identical to upstream HEAD on 2026-06-19 |
| Latest upstream HEAD as of 2026-06-19 | `10fe0054734eec83049514ea2e718b2a56acd0c9` |
...
cp src/parser.c        "$THIS_REPO/Sources/TreeSitterLua/src/parser.c"
cp src/tree_sitter/*.h "$THIS_REPO/Sources/TreeSitterLua/src/tree_sitter/" 2>/dev/null || true
# If the grammar ships a custom scanner, copy that too:
[ -f src/scanner.c ] && cp src/scanner.c "$THIS_REPO/Sources/TreeSitterLua/src/scanner.c"
